<template>
  <div>
    ...
    赋值：
    <br>
    <el-button @click="setStringHandler1">您已登出系统或已被强制下线的json串儿</el-button>
    <br>
    <el-button @click="setStringHandler2">token错误或者token失效的json串儿</el-button>
    <br>

    <br>
    调用：
    <el-button @click="ajaxErrorCheck">ajaxErrorCheck</el-button>
    <div>
